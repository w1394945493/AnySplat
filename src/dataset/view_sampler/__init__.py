...
from .view_sampler_bounded_re10k import ViewSamplerBoundedRe10k,ViewSamplerBoundedRe10kCfg
VIEW_SAMPLERS: dict[str, ViewSampler[Any]] = {
    ...
    "bounded_re10k": ViewSamplerBoundedRe10k, #?
}
